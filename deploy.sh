cp init.py ConfigTree.py flaskserver.py hostfinder.py ptoken testaerospike.service /Users/atul.intern/Deploy/
cp init.py ConfigTree.py flaskserver.py hostfinder.py ptoken testaerospike.service ../aspy/
